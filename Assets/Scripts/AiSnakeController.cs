...
public class AiSnakeController : ISnakeController
{
    public AiSnakeHead snakeHead;
...
//          TODO  check if snake ate first
    ...
    protected override void InstantiateSnakeHead()
    {
        ...
        GameObject snakeHead = snakeParts.Find(i => i.CompareTag("AiSnakeHead"));
...
//     not implemented   
    ...
    {
        snakeHead = gameObject.GetComponent<AiSnakeHead>();
...
//        TODO Also check if food has been eaten with an OR! Otherwise snake never gets longer
        if (snakeBody.Count > 0 || foodEaten)
        {
            ...
            spawnerController.SpawnAiSnakeBodyPart(snakeBodyPart, snakeBodyPartPos);
